...
const TwoFactorAuthentication = (props) => {
  ...
  // const handleScrollUp = () => scrollRef.current?.scrollTo({
  //   y: 0,
  //   animated: true,
  // });
          ...
          <View
            ...
            <View style={{
              ...
              <View style={styles(activeTheme).drawInner}>
                ...
                <Text style={styles(activeTheme).secondText}>{getLang(language, "SMS_CONFIRMATION")}</Text>
                <Text
            ...
            {
              activeKey === "sms" && <TinyImage parent={"rest/"} name={"success"} style={styles(activeTheme).icon} />
            }
