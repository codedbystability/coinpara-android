    ...
    >
      ...
      <KeyboardAvoidingView behavior={"padding"} style={{ flex: 1 }}>
        <View style={styles(activeTheme).container}>
          ...
          <View style={{ paddingBottom: PADDING_H * 2 }}>
...
const styles = (props) => StyleSheet.create({
  container: {
    ...
    alignItems: "center",
    justifyContent: "center",
    // paddingTop: isIphoneX ? MARGIN_T : MARGIN_T / 2,
  ...
  img: {
    marginVertical: isIphoneX ? PADDING_H * 2 : PADDING_H,
